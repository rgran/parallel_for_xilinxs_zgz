...
for BLOCK in  8 16 32 64 128 256 512 1024 2048 4096; do
...
cat  HOTSPOT_MultiDyn_${nc}_${nf}.txt >>  HOTSPOT_MultiDyn_${nc}_${nf}_${freq}.txt 
rm  HOTSPOT_MultiDyn_${nc}_${nf}.txt 
fi
done
done
done

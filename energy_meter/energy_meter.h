...
// ANDRES: reducimos las lecturas de sensores al mínimo necesario
#define NUM_SENSORS 12 // 18 //ultrascale

#define PSD_rails 5 //10  //last sensor index
#define PLD_rails 12 // 18 //last sensor index
